...
namespace PDI_Tarea_3 {
	public partial class Form : System.Windows.Forms.Form {
		...
		public Form() {
            ...
            trackBarRotacion.Enabled = false;
        }
        ...
        private void chkInterBi_CheckedChanged(object sender, EventArgs e)
        {
            if (chkInterBi.Checked)
            {

                trackBarRotacion.Enabled = true;
                nearestNeighborToolStripMenuItem.Enabled = true;
                nearestNeighborToolStripMenuItem.Checked = false;
                bilinealToolStripMenuItem.Checked = true;
                bilinealToolStripMenuItem.Enabled = false;
        ...
        private void trackBarRotacion_Scroll(object sender, EventArgs e)
        {
